...
// Product overlay buttons functionality
...
function showQuickView(button) {
    ...
    modal.innerHTML = `
        ...
        ">
            ...
            <p style="color: #9ca3af; margin-bottom: 24px;">Premium quality clothing with modern design and comfortable fit. Available in multiple sizes and colors.</p>
